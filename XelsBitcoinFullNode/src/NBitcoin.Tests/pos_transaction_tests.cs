...
namespace NBitcoin.Tests
{
    public class pos_transaction_tests
    {
        ...
        {
            // These tests should be using the Xels network.
        ...
        {
            ConcurrentChain chain = new ConcurrentChain(Network.XelsMain);
        ...
        private ChainedBlock CreateBlock(DateTimeOffset now, int offset, ChainBase chain = null)
        {
            ...
            if (chain != null)
            {
                ...
                return new ChainedBlock(b.Header, b.Header.GetHash(Network.XelsMain.NetworkOptions), chain.Tip);
            }
            else
                return new ChainedBlock(b.Header, b.Header.GetHash(Network.XelsMain.NetworkOptions), 0);
        }
        ...
        public void CanExtractTxOutDestinationEasily()
        {
            ...
            var secret = new BitcoinSecret("VHqBm5xVQvosc7u4dDwMmzbr8mL4KzZBn5VgqjunovgURtXBo5cV", Network.XelsMain);
