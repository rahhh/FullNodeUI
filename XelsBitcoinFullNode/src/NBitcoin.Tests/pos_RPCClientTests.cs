...
namespace NBitcoin.Tests
{
    ...
    public class pos_RPCClientTests
    {
        ...
        //        builder.StartAll();
        //        Key key = new Key();
        //        rpc.ImportAddress(key.PubKey.GetAddress(Network.XelsMain), TestAccount, false);
        ...
        //        var network = ((string)test[1]) == "Main" ? Network.XelsMain : Network.XelsMain;
         ...
         * TODO: Consider importing to FN.
            ...
            using (var builder = NodeBuilderXels.Create())
            {
                ...
                using(var node = nodeA.CreateNodeClient())
                {
                    ...
                    var peers = rpc.GetXelsPeersInfoAsync().Result;
