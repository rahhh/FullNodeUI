...
namespace Xels.Bitcoin.Features.Consensus
{
    ...
    {
        /// <summary>List of selected checkpoints for XELS mainnet.</summary>
        private static Dictionary<int, CheckpointInfo> xelsMainnetCheckpoints = new Dictionary<int, CheckpointInfo>
        {
        ...
        /// <summary>List of selected checkpoints for XELS testnet.</summary>
        private static Dictionary<int, CheckpointInfo> xelsTestnetCheckpoints = new Dictionary<int, CheckpointInfo>
        {
        ...
        public Checkpoints(Network network, ConsensusSettings settings)
        {
            ...
            else if (network.Equals(Network.XelsMain)) this.checkpoints = xelsMainnetCheckpoints;
            else if (network.Equals(Network.XelsTest)) this.checkpoints = xelsTestnetCheckpoints;
