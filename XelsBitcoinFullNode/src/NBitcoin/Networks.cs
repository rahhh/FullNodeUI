...
namespace NBitcoin
{
    public partial class Network
    {
        ...
        public static Network XelsMain => Network.GetNetwork("XelsMain") ?? InitXelsMain();

        public static Network XelsTest => Network.GetNetwork("XelsTest") ?? InitXelsTest();

        public static Network XelsRegTest => Network.GetNetwork("XelsRegTest") ?? InitXelsRegTest();
        ...
        private static Network InitXelsMain()
        {
            ...
            consensus.SubsidyHalvingInterval = 1014286;
            consensus.MajorityEnforceBlockUpgrade = 750;
            consensus.MajorityRejectBlockOutdated = 950;
            consensus.MajorityWindow = 1000;
            consensus.BuriedDeployments[BuriedDeployments.BIP34] = 227931;
            ...
            consensus.PowTargetTimespan = TimeSpan.FromSeconds(14 * 24 * 60 * 60); // two weeks
            consensus.PowTargetSpacing = TimeSpan.FromSeconds(2.5 * 60);
            consensus.PowAllowMinDifficultyBlocks = false;
            consensus.PowNoRetargeting = false;
            consensus.RuleChangeActivationThreshold = 1916; // 95% of 2016
            consensus.MinerConfirmationWindow = 2016; // nPowTargetTimespan / nPowTargetSpacing
            ...
            var builder = new NetworkBuilder()
                .SetName("XelsMain")
                .SetRootFolderName(XelsRootFolderName)
                .SetDefaultConfigFilename(XelsDefaultConfigFilename)
                ...
                .SetMaxTimeOffsetSeconds(XelsMaxTimeOffsetSeconds)
                .SetMaxTipAge(XelsDefaultMaxTipAgeInSeconds)
                ...
                .SetBase58Bytes(Base58Type.PUBKEY_ADDRESS, new byte[] { (75) })  // 75 for capital X
                .SetBase58Bytes(Base58Type.SCRIPT_ADDRESS, new byte[] { (137) }) // 137 for small x
                ...
                .SetBech32(Bech32Type.WITNESS_PUBKEY_ADDRESS, "xc")
                .SetBech32(Bech32Type.WITNESS_SCRIPT_ADDRESS, "xc");
        ...
        private static Network InitXelsTest()
        {
            Block.BlockSignature = true;
            Transaction.TimeStamp = true;

            var consensus = Network.XelsMain.Consensus.Clone();
            ...
            var genesis = Network.XelsMain.GetGenesis();
        ...
        private static Network InitXelsRegTest()
        {
            // TODO: move this to Networks
            var net = Network.GetNetwork("XelsRegTest");
            if (net != null)
                return net;
            ...
            var consensus = Network.XelsTest.Consensus.Clone();
        ...
        private static Block CreateXelsGenesisBlock(string pszTimestamp, uint nTime, uint nNonce, uint nBits, int nVersion, Money genesisReward)
        {
            ...
            ////////////////////// Neo: add premine transaction to Genesis Block
