...
namespace Xels.Bitcoin.Configuration
{
    ...
    public class NodeSettings
    {
        ...
        public NodeSettings(Network innerNetwork = null, ProtocolVersion protocolVersion = SupportedProtocolVersion, 
            string agent = "XelsBitcoin", string[] args = null, bool loadConfiguration = true)
        {
            this.Agent = agent;
        ...
        public NodeSettings LoadConfiguration()
        {
            ...
            {
                this.DataDir = this.CreateDefaultDataDirectories(Path.Combine("XelsNode", this.Network.RootFolderName), this.Network);
            }
            else
            {
        ...
        public static void PrintHelp(Network network)
        {
            ...
            builder.AppendLine(" dotnet exec <Xels.XelsD/BitcoinD.dll> [arguments]");
            builder.AppendLine();
