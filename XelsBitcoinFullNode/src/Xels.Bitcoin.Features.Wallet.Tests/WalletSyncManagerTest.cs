...
namespace Xels.Bitcoin.Features.Wallet.Tests
{
    public class WalletSyncManagerTest : LogsTestBase
    {
        ...
        {
            // These tests use Network.XelsMain.
            ...
            this.chain = new ConcurrentChain(Network.XelsMain);
        ...
        public void Start_HavingPrunedStoreSetting_ThrowsWalletException()
        {
            ...
            var walletSyncManager = new WalletSyncManager(this.LoggerFactory.Object, this.walletManager.Object, this.chain, Network.XelsMain,
        ...
        {
            this.storeSettings.Prune = false;
            this.chain = WalletTestsHelpers.GenerateChainWithHeight(5, Network.XelsMain);
        ...
        {
            var result = WalletTestsHelpers.GenerateChainAndBlocksWithHeight(5, Network.XelsMain);
            this.chain = result.Chain;
            var blocks = result.Blocks;
            var walletSyncManager = new WalletSyncManagerOverride(this.LoggerFactory.Object, this.walletManager.Object, this.chain, Network.XelsMain,
                this.blockStoreCache.Object, this.storeSettings, this.nodeLifetime.Object);
        ...
        {
            var result = WalletTestsHelpers.GenerateForkedChainAndBlocksWithHeight(5, Network.XelsMain, 2);
        ...
        {
            this.chain = WalletTestsHelpers.GenerateChainWithHeight(3, Network.XelsMain);
        ...
        {
            this.chain = WalletTestsHelpers.GenerateChainWithHeight(1, Network.XelsMain);
