...
You just need to edit the file and specify whether you want to run a Xels or a Bitcoin node, on MainNet or Testnet.  
It's located [here](https://gist.github.com/bokobza/e68832f5d7d4102bcb33fcde8d9a72fb#file-build-and-run-a-xels-node-ps1).


Docker Containers
-------------------

Two containers are available [here](https://hub.docker.com/u/xelsplatform/)

- xels-node: Run on the Bitcoin Main or Test networks
- xels-node-sim: Join our simulation network
